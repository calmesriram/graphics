...
contract Fixed_Deposit is Bank,Loan_Details
{
    ...
    function fix_dep(address bank_address,uint256 amt,uint8 year)public payable
    {
        ...
        fix_user[msg.sender][ fix_user_count[msg.sender] ].id=i;
        ...
        fix_user[msg.sender][ fix_user_count[msg.sender] ].id++;
